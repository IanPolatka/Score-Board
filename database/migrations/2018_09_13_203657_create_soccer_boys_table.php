...
class CreateSoccerBoysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('soccer_boys', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('end_in_pks')->nullable();
    ...
    {
        Schema::dropIfExists('soccer_boys');
    }
}
