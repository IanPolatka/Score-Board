			...
			<div v-else class="card">
				<div class="card-header">
					<div class="d-flex justify-content-between">
						<span><strong>Boys Soccer</strong></span>
				...
				<div class="card-body">
					<div class="mb-3 d-flex justify-content-between align-items-center">
						<span><img style="height: 40px; width: auto; margin-right: 10px;" 
							   ...
							   <a :href="'/boys-soccer/' + game.the_year.year + '/' + game.away_team.school_name">{{game.away_team.school_name}}</a>
						</span>
						<span v-if="game.game_status > 1">
							{{game.away_score_sum}}
						</span>
					...
					<div class="d-flex justify-content-between align-items-center">
						<span><img style="height: 40px; width: auto; margin-right: 10px;" 
							  ...
							  <a :href="'/boys-soccer/' + game.the_year.year + '/' + game.home_team.school_name">{{game.home_team.school_name}}</a>
						</span>
						<span v-if="game.game_status > 1">
							{{game.home_score_sum}}
						</span>
...
<script>
	...
	export default {
		...
		methods: {
			fetchEvent() {
				axios.get('/api/soccer-boys/' + this.matchId)
				.then(res =>  {
	                    this.game = res.data,
