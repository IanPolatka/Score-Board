				...
				<div class="card-body">
					<div class="mb-3 d-flex justify-content-between align-items-center">
						<span><img style="height: 40px; width: auto; margin-right: 10px;" 
							   ...
							   <a :href="'/girls-golf/' + match.the_year.year + '/' + match.away_team.school_name">{{match.away_team.school_name}}</a>
						</span>
					...
					<div class="d-flex justify-content-between align-items-center">
						<span><img style="height: 40px; width: auto; margin-right: 10px;" 
							  ...
							  <a :href="'/girls-golf/' + match.the_year.year + '/' + match.home_team.school_name">{{match.home_team.school_name}}</a>
						</span>
