        ...
        <div class="col-md-8">
            ...
            <div class="row justify-content-center mb-4">
                ...
                @role(['superadministrator','administrator', 'editor'])
                    <div class="col align-self-end">
                        <a href="{{ route('football.create') }}" class="btn btn-primary btn-block">Create Game</a>
                    </div>
                @endrole
            ...
            <div class="list-group">
                @forelse ($todaysGames as $game)
                    <a href="/football/{{$game->id}}" class="list-group-item list-group-item-action">
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-3 text-right">
                                ...
                                @elseif ($game->game_status === 1)
                                    ...
                                    @else
                                        <strong>{{$game->away_score_sum}}</strong>
                                    @endif
                                @else
                                    {{$game->game_time->time}}
                                @endif
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-3 text-right">
                                ...
                                @elseif ($game->game_status === 1)
                                    ...
                                    @else
                                        <strong>{{$game->home_score_sum}}</strong>
                                    @endif
                                @else
