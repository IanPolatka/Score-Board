            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/boys-basketball/{{$match->id}}">Game ID: {{$match->id}}</a></li>
        ...
        <div class="col">
            ...
            <div class="score-summary-summary">
                ...
                <div class="away-team">
                    ...
                    <div class="the-logo">
                        <a href="/boys-basketball/{{$match->the_year->year}}/{{ $match->away_team->school_name }}"><img class="school-logo" src="/images/team-logos/{{ $match->away_team->logo }}" /></a>
                    </div>
                ...
                <div class="home-team">
                    ...
                    <div class="the-logo">
                        <a href="/boys-basketball/{{$match->the_year->year}}/{{ $match->home_team->school_name }}"><img class="school-logo" src="/images/team-logos/{{ $match->home_team->logo }}" /></a>
                    </div>
                    ...
                    <div class="school-name">
                        <h5 class="inline-text text-uppercase">
                            <a href="/boys-basketball/{{$match->the_year->year}}/{{$match->home_team->school_name}}">
        ...
        <div class="col-md-12 @if($match->game_status != 4 && $match->game_status > 1) mt-4 @endif">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/boys-basketball-half-update/{{ $score->id }}">
                        <div class="row mb-4">
                        {{ method_field('PATCH') }}
                        @csrf
                            <div class="col">
                ...
                <div class="card-footer text-muted" @if($scores->isEmpty()) style="border-top: none;" @endif>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <form method="POST" action="/boys-basketball-score-create/{{$match->id}}">
                        ...
                        <div class="col">
                            ...
                            <form method="POST" action="/boys-basketball-score-delete/{{$score->id}}">
            ...
            <form method="POST" action="/boys-basketball/{{$match->id}}/match-update">
