        ...
        <div class="col-md-8">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-9">
                            ...
                            @if($game->away_team_final_score && ($game->away_team_final_score > $game->home_team_final_score))
                                <strong><a href="/softball/2018-2019/{{$game->away_team->school_name}}">{{$game->away_team->school_name}} ({{$game->away_team->state}})</a></strong>
                            @else
                                <a href="/softball/2018-2019/{{$game->away_team->school_name}}">{{$game->away_team->school_name}}</a>
                            @endif
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-9">
                            ...
                            @if($game->home_team_final_score && ($game->home_team_final_score > $game->away_team_final_score))
                                <span><strong><a href="/softball/2018-2019/{{$game->home_team->school_name}}">{{$game->home_team->school_name}} ({{$game->home_team->state}})</a></strong></span>
                            @else
                                <span><a href="/softball/2018-2019/{{$game->home_team->school_name}}">{{$game->home_team->school_name}} ({{$game->home_team->state}})</a><br />
                            @endif
                        </div>
                        <div class="col-3 text-right">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                    <a href="{{ route('softball-edit', $game->id)}}" class="btn btn-primary btn-block">Edit Game</a> 
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                    <a href="{{ route('softball-score-edit', $game->id)}}" class="btn btn-primary btn-block">Edit Game Play</a> 
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 mb-3">

                    <form method="POST" action="/softball/delete/{{ $game->id }}">
