            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/girls-soccer/{{$match->id}}">Game ID: {{$match->id}}</a></li>
        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/girls-soccer-half-update/{{ $score->id }}">
                        <div class="row mb-4">
                        {{ method_field('PATCH') }}
                        @csrf
                            <div class="col">
                ...
                <div class="card-footer text-muted" @if($scores->isEmpty()) style="border-top: none;" @endif>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <form method="POST" action="/girls-soccer-score-create/{{$match->id}}">
                        ...
                        <div class="col">
                            ...
                            <form method="POST" action="/girls-soccer-score-delete/{{$score->id}}">
            ...
            <form method="POST" action="/girls-soccer/{{$match->id}}/match-update">
