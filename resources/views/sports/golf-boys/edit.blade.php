            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/boys-golf/{{$match->id}}">Match ID: {{$match->id}}</a></li>
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('boysgolf-edit-match', $match->id)}}" method="POST">
                        {{method_field('PUT')}}
                        {{csrf_field()}}
...
@include('sports.golf-boys.twitter')
<script>
