                    ...
                    <div class="form-group mb-0">
                        ...
                        <select class="form-control" id="teams" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                <option value="/boys-golf/{{ $selectedyear[0] }}/{{$team->school_name}}" @if ($team->school_name == $selectedTeam->school_name) selected @endif>{{$team->school_name}}</option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <div class="col-lg-3 col-md-4 col-sm-5 col-5 align-self-center">
                    ...
                    <select name="home_team_id"class="form-control" onChange="window.location.href=this.value">
                        ...
                        @foreach($years as $year)
                            ...
                            <option value="/boys-golf/{{ $year->year }}/{{ $selectedTeam->school_name }}" @if ($selectedyearid[0] === $year->id) selected @endif>
                                {{ $year->year }}
                            </option>
            ...
            <div class="list-group mb-4">
                @forelse ($varsity as $game)
                    <a href="/boys-golf/{{$game->id}}" class="list-group-item list-group-item-action">
