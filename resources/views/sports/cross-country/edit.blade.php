            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/cross-country/{{$match->id}}">Event ID: {{$match->id}}</a></li>
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('cross-country.edit.match', $match->id)}}" method="POST">
                        {{method_field('PUT')}}
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <label for="scrimmage">Is this event a scrimmage?</label>
