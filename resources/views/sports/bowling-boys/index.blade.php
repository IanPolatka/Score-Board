            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Boys Bowling</li>
                  </ol>
                </nav>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
			...
			<h3 class="title">Boys Bowling</h3>
            ...
            <div class="row justify-content-center mb-4">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <select class="form-control" id="teams" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                <option value="/boys-bowling/2018-2019/{{$team->school_name}}">{{$team->school_name}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                @role(['superadministrator','administrator'])
                    <div class="col align-self-end">
                        <a href="{{ route('boys-bowling.create') }}" class="btn btn-primary btn-block">Create Match</a>
                    </div>
                @endrole
