            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/boys-tennis">Boys Tennis</a></li>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-9">
                            ...
                            @if($game->away_team_final_score && ($game->away_team_final_score > $game->home_team_final_score))
                                <strong><a href="/boys-tennis/2018-2019/{{$game->away_team->school_name}}">{{$game->away_team->school_name}} ({{$game->away_team->state}})</a></strong>
                            @else
                                <a href="/boys-tennis/2018-2019/{{$game->away_team->school_name}}">{{$game->away_team->school_name}}</a>
                            @endif
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-9">
                            ...
                            @if($game->home_team_final_score && ($game->home_team_final_score > $game->away_team_final_score))
                                <span><strong><a href="/boys-tennis/2018-2019/{{$game->home_team->school_name}}">{{$game->home_team->school_name}} ({{$game->home_team->state}})</a></strong></span>
                            @else
                                <span><a href="/boys-tennis/2018-2019/{{$game->home_team->school_name}}">{{$game->home_team->school_name}} ({{$game->home_team->state}})</a><br />
                            @endif
                        </div>
                        <div class="col-3 text-right">
            ...
            <div class="row">
                ...
                <div class="col">
                    <a href="{{ route('boys-tennis.edit', $game->id)}}" class="btn btn-primary btn-block">Edit Match</a> 
                </div>
                <div class="col">

                    <form method="POST" action="/boys-tennis/delete/{{ $game->id }}">
