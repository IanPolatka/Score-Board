            ...
            <div class="row justify-content-center mb-4">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <select class="form-control" id="teams" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                <option value="/boys-tennis/2018-2019/{{$team->school_name}}" @if ($team->school_name == $selectedTeam->school_name) selected @endif>{{$team->school_name}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                @role(['superadministrator','administrator'])
                    <div class="col align-self-end">
                        <a href="{{ route('boys-tennis.create') }}" class="btn btn-primary btn-block">Create Match</a>
                    </div>
                @endrole
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
            ...
            <div class="list-group mb-4">
                @forelse ($varsity as $game)
                    <a href="/boys-tennis/{{$game->id}}" class="list-group-item list-group-item-action">
