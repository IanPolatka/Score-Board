            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Girls Tennis</li>
                  </ol>
                </nav>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
			...
			<h3 class="title">Girls Tennis</h3>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <select class="form-control" id="teams" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                <option value="/girls-tennis/2018-2019/{{$team->school_name}}">{{$team->school_name}}</option>
                            @endforeach
                        </select>
                    </div>
