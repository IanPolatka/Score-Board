        ...
        <div class="col">
            ...
            <div class="score-summary-summary">
                ...
                <div class="away-team">
                    ...
                    <div class="the-logo">
                        <a href="/girls-basketball/{{$match->the_year->year}}/{{ $match->away_team->school_name }}"><img class="school-logo" src="/images/team-logos/{{ $match->away_team->logo }}" /></a>
                    </div>
                    ...
                    <div class="school-name">
                        <h5 class="inline-text text-uppercase">
                            <a href="/girls-basketball/{{$match->the_year->year}}/{{$match->away_team->school_name}}">
                ...
                <div class="home-team">
                    ...
                    <div class="the-logo">
                        <a href="/girls-basketball/{{$match->the_year->year}}/{{ $match->home_team->school_name }}"><img class="school-logo" src="/images/team-logos/{{ $match->home_team->logo }}" /></a>
                    </div>
                    ...
                    <div class="school-name">
                        <h5 class="inline-text text-uppercase">
                            <a href="/girls-basketball/{{$match->the_year->year}}/{{$match->home_team->school_name}}">
