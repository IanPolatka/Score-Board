            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Girls Golf</li>
                  </ol>
                </nav>
        ...
        <div class="col-md-8">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <select class="form-control" id="teams" onChange="window.location.href=this.value">
                            ...
                            @foreach($teams as $team)
                                <option value="/girls-golf/{{ $theCurrentYear[0]->year }}/{{$team->school_name}}">{{$team->school_name}}</option>
                            @endforeach
                        </select>
                    </div>
            ...
            <div class="list-group">
                @forelse ($todaysMatches as $match)
                    <a href="/girls-golf/{{$match->id}}" class="list-group-item list-group-item-action">
