        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('volleyball-create-game')}}" method="POST">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="" name="time_id" @if ($errors->has('home_team_id')) style="border-color: #dc3545;" @endif>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                ...
                                <div class="form-group">
                                    <label for="district_game">District Match</label>
                        ...
                        <button type="submit" class="btn btn-primary btn-block mt-4">Create Match</button>
